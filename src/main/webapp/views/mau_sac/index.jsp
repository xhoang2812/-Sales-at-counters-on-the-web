...
<div style="text-align: center">
    <h3>Danh Sach Mau Sac</h3>
</div>
<div style="text-align: end">
    <a class="btn btn-warning" href="/mau-sac/create">Them</a>
</div>
<div>
    <form method="get" action="/mau-sac/tim-theo-ten" class="row d-flex">
        <div class="col-3">
    ...
    <table class="table table-striped">
        ...
        <c:forEach items="${listMS}" var="list">
            <tr>
                ...
                <td>
                    <a class="btn btn-danger" href="/mau-sac/delete/${list.id}">Xoa</a>
                    <a class="btn btn-info" href="/mau-sac/edit/${list.id}">Chi Tiet</a>
                </td>
            </tr>
        </c:forEach>
        </tbody>
...
<div class="d-flex justify-content-center">
    <nav aria-label="Page navigation example">
        <ul class=" pagination">
<%--            <li class="page-item"><a class="page-link" href="/mau-sac/hien-thi?page=1&limit=5">First</a></li>--%>
<%--            <c:if test="${currentPage > 1}">--%>
<%--                <li class="page-item"><a class="page-link"--%>
<%--                                         href="/mau-sac/hien-thi?page=${currentPage - 1}&limit=5">Prev</a></li>--%>
<%--            </c:if>--%>
            <c:forEach begin="1" end="${totalPages}" var="i">
                <c:choose>
                    <c:when test="${i == currentPage}">
                        <li class="page-item"><a style="color: red; text-decoration:underline;"
                                                 class="page-link">${i}</a></li>
                    </c:when>
                    <c:otherwise>
                        <li class="page-item"><a class="page-link" href="/mau-sac/hien-thi?page=${i}&limit=5">${i}</a>
                        </li>
                    </c:otherwise>
                </c:choose>
            </c:forEach>
...
<%--                <li class="page-item"><a class="page-link"--%>
<%--                                         href="/mau-sac/hien-thi?page=${currentPage + 1}&limit=5">Next</a></li>--%>
<%--            </c:if>--%>
<%--            <li class="page-item"><a class="page-link" href="/mau-sac/hien-thi?page=${totalPages}&limit=5">Last</a></li>--%>
        </ul>
    </nav>
</div>
</body>
