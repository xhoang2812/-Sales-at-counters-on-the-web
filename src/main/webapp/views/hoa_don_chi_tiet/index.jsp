    ...
    <table class="table table-striped">
        ...
        <c:forEach items="${listHDCT}" var="list">
            <tr>
                ...
                <td>
                    <a class="btn btn-info" href="/hoa-don-chi-tiet/edit/${list.id}">Chi Tiet</a>
                </td>
            </tr>
        </c:forEach>
        </tbody>
        ...
        <ul class=" pagination">
            <c:forEach begin="1" end="${totalPages}" var="i">
                <c:choose>
                    ...
                    <c:otherwise>
                        <li class="page-item"><a class="page-link" href="/hoa-don-chi-tiet/hien-thi?page=${i}&limit=${limit}">${i}</a></li>
                    </c:otherwise>
                </c:choose>
            </c:forEach>
        </ul>
