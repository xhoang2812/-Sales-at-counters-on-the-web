...
<div style="text-align: end">
    <a class="btn btn-warning" href="/khach-hang/create">Them</a>
</div>
<div>
    <form method="get" action="/khach-hang/tim-theo-ten" class="row d-flex">
        <div class="col-3">
    ...
    <table class="table table-striped">
        ...
        <c:forEach items="${listKH}" var="list">
            <tr>
                ...
                <td>
                    <a class="btn btn-danger" href="/khach-hang/delete/${list.id}">Xoa</a>
                    <a class="btn btn-info" href="/khach-hang/edit/${list.id}">Chi Tiet</a>
                </td>
            </tr>
        </c:forEach>
        </tbody>
        ...
        <ul class=" pagination">
            <c:forEach begin="1" end="${totalPages}" var="i">
                <c:choose>
                    ...
                    <c:otherwise>
                        <li class="page-item"><a class="page-link" href="/khach-hang/hien-thi?page=${i}&limit=10">${i}</a></li>
                    </c:otherwise>
                </c:choose>
            </c:forEach>
        </ul>
