...
<div style="text-align: center">
    <h3>Danh Sach San Pham Chi Tiet</h3>
</div>
<div style="text-align: end">
    <a class="btn btn-warning" href="/san-pham-chi-tiet/create">Them</a>
</div>
<div>
    <form method="get" action="/san-pham-chi-tiet/tim-kiem-theo-san-pham" class="row d-flex">
        <div class="col-3">
            <label class="form-label">Loc Theo San Pham</label>
    ...
    <table class="table table-striped">
        ...
        <c:forEach items="${listSPCT}" var="list">
            <tr>
                ...
                <td>
                    <a class="btn btn-danger" href="/san-pham-chi-tiet/delete/${list.id}">Xoa</a>
                    <a class="btn btn-info" href="/san-pham-chi-tiet/edit/${list.id}">Chi Tiet</a>
                </td>
            </tr>
        </c:forEach>
        </tbody>
        ...
        <ul class="pagination">
            <c:forEach begin="1" end="${totalPages}" var="i">
                <c:choose>
                    ...
                    <c:otherwise>
                        <li class="page-item"><a class="page-link" href="/san-pham-chi-tiet/hien-thi?page=${i}&limit=${limit}">${i}</a>
                        </li>
                    </c:otherwise>
                </c:choose>
            </c:forEach>
