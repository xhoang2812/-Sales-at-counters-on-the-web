...
<div style="text-align: end">
    <a class="btn btn-warning" href="/nhan-vien/create">Them</a>
</div>
<div>
    <form method="get" action="/nhan-vien/tim-theo-ten" class="row d-flex">
        <div class="col-3">
    ...
    <table class="table table-striped">
        ...
        <c:forEach items="${listNV}" var="list">
            <tr>
                ...
                <td>${list.matKhau}</td>
                <td>${list.trangThai == 1 ? "Admin" : "User"}</td>
                <td>
                    <a class="btn btn-danger" href="/nhan-vien/delete/${list.id}">Xoa</a>
                    <a class="btn btn-info" href="/nhan-vien/edit/${list.id}">Chi Tiet</a>
                </td>
            </tr>
        </c:forEach>
        </tbody>
        ...
        <ul class=" pagination">
            <c:forEach begin="1" end="${totalPages}" var="i">
                <c:choose>
                    ...
                    <c:otherwise>
                        <li class="page-item"><a class="page-link" href="/nhan-vien/hien-thi?page=${i}&limit=${limit}">${i}</a></li>
                    </c:otherwise>
                </c:choose>
            </c:forEach>
        </ul>
